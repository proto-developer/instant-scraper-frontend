...
const AccountSettingSidebar = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row text-white">
      {/* Sidebar */}
      <div className="w-full md:w-[43%] lg:w-[35%] md:h-full md:mr-0">
        {/* My Account Section */}
        <div className="py-4 text-center md:py-5 md:text-left">
          <div className="flex flex-row  justify-self-center md:justify-self-stretch items-center mt-4 md:mt-0 md:items-start  md:ml-5">
            ...
            />
            <h4 className="text-[24px] md:text-lg lg:text-xl ml-3 md:ml-0 mb-2 md:mt-1">My Account</h4>
          </div>
        </div>
        ...
        <div className="block md:hidden text-center">
          <button
            ...
            className="bg-[#282829] text-white w-[95%]  text-[16px] mx-auto flex items-center justify-between p-3 rounded-md"
          >
            <span>{selectedOption}</span> {/* Show the selected option */}
            <span className="text-sm">&#x25BC;</span> {/* Dropdown arrow */}
          </button>
          {dropdownOpen && (
            <ul className="bg-[#1E1E1F] w-[90%] mx-auto mt-2 rounded-md text-[16px] text-[#6F767E]">
      ...
      {/* Content Section */}
      <div className="w-full md:w-[75%] p-[0px_12px] md:py-[85px] lg:py-11 md:px-8">
