...
const Home = () => {
  ...
  const handleStartScrapping = () => {
    ...
    // Redirect to /processing-data with the inputs
    router.push(`/processing-data?url=${encodeURIComponent(url)}&query=${encodeURIComponent(query)}`);
  };
      ...
      <div className="w-full h-[100dvh] flex flex-col px-4 sm:px-8 justify-between">
        ...
        <div className="mt-auto mb-auto">
          <div className="text-center h-auto md:h-[100%] flex flex-col md:justify-center">
            ...
            <p className="text-[17px] md:text-base 2xl:text-xl font-normal mt-4 mb-4 md:mb-8">
              Unleash AI to Fetch the Data You Need
            </p>
            ...
            <div className="w-full md:w-[90%] mx-auto">
              ...
              <div className="w-full flex justify-end">
                <StartNewScrapBtn onClick={handleStartScrapping} />
              </div>
            </div>
          </div>
        </div>
